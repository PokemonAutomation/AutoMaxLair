...
# I removed accent and weird letter on purpose because python has issue with them
...
english_to_french_ability = {
    ...
    "Dark Aura"         : "Aura Tenebreuse" ,
    "Power Construct"   : "Rassemblement"   ,
    "Electric Surge"    : "Crea-Elec"       ,
    "Psychic Surge"     : "Crea-Psy"        ,
    "Grassy Surge"      : "Crea-Herbe"      ,
    "Misty Surge"       : "Crea-Brume"      ,
    "Full Metal Body"   : "Métallo-Garde"   ,
    "Shadow Shield"     : "Spectro-Bouclier",
    "Beast Boost"       : "Boost Chimere"   ,
    "Prism Armor"       : "Prisme-Armure"   ,
    # todo add rental
    "Chlorophyll"       : "Chlorophylle"    ,
    "Solar Power"       : "Force Soleil"    ,
    "Rain Dish"         : "Cuvette"         ,
    "Tinted Lens"       : "Lentiteintee"    ,
    ...
    "Anger Point"       : "Colerique"       ,
    "Imposter"          : "Imposteur"       ,
    "Volt Absorb"       : "Absorbe-Volt"    ,
    "Download"          : "Telecharge"      ,
    "Shed Skin"         : "Mue"             ,
    "Serene Grace"      : "Serenite"        ,
    ...
    "Disguise"          : "Fantomasque"     ,
    "Cheek Pouch"       : "Bajoues"         ,
    "Fluffy"            : "Boule de Poils"  ,
    "Steam Engine"      : "Turbine"         ,
    "Sand Spit"         : "Expul'Sable"     ,
    "Gulp Missile"      : "Degobage"        ,
    "White Smoke"       : "Ecran Fumee"     ,
    "Anticipation"      : "Anticipation"    ,
    "Reckless"          : "Temeraire"       ,
    "Steely Spirit"     : "Boost Acier"     ,
    "Aroma Veil"        : "Aroma-Voile"     ,
    "Ice Scales"        : "Ecailles Glacees",
    "Hunger Switch"     : "Declic Fringale" ,
    "Light Metal"       : "Light Metal"
}

english_to_french_type = {
    "Fighting"  : "Combat"      ,
    "Water"     : "Eau"         ,
    "Flying"    : "Vol"         ,
    "Grass"     : "Plante"      ,
...
class MaxLairInstance():
    ...
    def identify_pokemon(self,
        ...
        for pokemon in self.rental_pokemon.values():
            ...
            string_to_match = english_to_french_pokemon_name[pokemon.name.split(' (')[0]]
            if ability != '':
                string_to_match += english_to_french_ability[pokemon.ability]
            if types != '':
                string_to_match += english_to_french_type[pokemon.types[0]] + english_to_french_type[pokemon.types[1]]
