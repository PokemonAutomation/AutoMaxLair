...
output_file = open("french_translation.py", "w", encoding='utf8')
...
species_french_file = open("text_Species_fr.txt", "r", encoding='utf8')
...
abilities_french_file = open("text_Abilities_fr.txt", "r", encoding='utf8')
...
types_french_file = open("text_Types_fr.txt", "r", encoding='utf8')
