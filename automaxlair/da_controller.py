...
class DAController(SwitchController):
    ...
    def __init__(
        ...
        # In-den rectangles.
        self.team_poke_rect_1 = ((0.012, 0.375), (0.05, 0.445))
        self.team_poke_rect_2 = ((0.012, 0.54), (0.05, 0.61))
        self.team_poke_rect_3 = ((0.012, 0.702), (0.05, 0.772))
        self.team_poke_rect_4 = ((0.012, 0.865), (0.05, 0.935))
