...
class DAController(SwitchController):
    ...
    def __init__(
        ...
        self.catch_dialogue_rect_1 = ((0.82, 0.845), (0.95, 0.855))
        self.catch_dialogue_rect_2 = ((0.82, 0.925), (0.95, 0.935))
    ...
    def read_in_battle_state(self) -> Optional[str]:
        ...
        if self.check_rect_HSV_match(
            self.catch_dialogue_rect_1, (0, 0, 0), (180, 10, 10), 200, img_hsv,
            already_HSV=True
        ) and self.check_rect_HSV_match(
            self.catch_dialogue_rect_2, (0, 0, 250), (180, 10, 255), 200,
